...
\begin{minipage}[t]{0.47\linewidth}
	...
	\includegraphics[width=.9\linewidth]{Прямоугольное окно230421.png}
	\textbf{Окно Кайзера}
	\includegraphics[width=.9\linewidth]{ОкноКазера230421.png}		
\end{minipage}
\hfill
\begin{minipage}[t]{0.47\linewidth}
	\centering 
	\textbf{Спектр с прям-ым окном}
	\includegraphics[width=.9\linewidth]{ПрямоугольныйСпект230421.png}
	\textbf{Спектр с окном Кайзера}
	\includegraphics[width=.9\linewidth]{СпектрОкняКайзера230421.png}
\end{minipage}
\end{frame}
...
\begin{frame}{Анализ быстродействия}
	...
	\includegraphics[width=.9\linewidth]{Direct correlation.pdf}
	\textbf{Pruned БПФ}
	\includegraphics[width=.9\linewidth]{Pruned_DFT.PNG}		
\end{minipage}
\hfill
\begin{minipage}[t]{0.43\linewidth}
	\centering 
	...
	\textbf{Sparse FFT}
	\includegraphics[width=.9\linewidth]{Sparse Fourier Transform.pdf}
\end{minipage}
\end{frame}
