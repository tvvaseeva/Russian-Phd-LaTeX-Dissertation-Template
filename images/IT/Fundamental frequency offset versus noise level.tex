...
% Легенда
\draw[ultra thick, black] (3, 5.9) -- (3.5, 5.9) node[right, black, font=\small] {- метод корреляционных функций};
\draw[ultra thick, blue]  (3, 5.6) -- (3.5, 5.6) node[right, black, font=\small] {- метод Якобсена};
\draw[ultra thick, green] (3, 5.3) -- (3.5, 5.3) node[right, black, font=\small] {- метод Макледона};
\draw[ultra thick, black!50] (3, 5) -- (3.5, 5) node[right, black, font=\small] {- второй метод Квина};
\draw[ultra thick, red] (3, 4.7) -- (3.5, 4.7) node[right, black, font=\small] {- метод Грэндка};
\draw[ultra thick, magenta] (3, 4.4) -- (3.5, 4.4) node[right, black, font=\small] {- алгоритм параболическоц};
\node[right, black, font=\small] at (3.75, 4.1){интерполяции};
\draw[ultra thick,cyan] (3, 3.8) -- (3.5, 3.8) node[right, black, font=\small] {- алгоритм интерполяции Гаусса};
\end{tikzpicture}
\end{center}
\end{document}
