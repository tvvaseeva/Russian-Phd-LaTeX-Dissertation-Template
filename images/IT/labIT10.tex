...
%	\definecolor{cyan(process)}{rgb}{0.0, 0.72, 0.92}
		...
		\node at (4.4,8.4) {$h+2$};
		\node at (12.3,8.4) {$h+4$};
		\node at (4.4,9) {Гармоническая группа};
		\node at (12.3,9.2) {Интергармоническая группа};
		...
		\node at (14.3,-1.1) {Выход ДПФ-вычислителя};
		%\node at (14.3,-1.6) {преобразования};
		%\node at (14.3,-2.1) {Фурье};
	\begin{scope}[azure(colorwheel)!78!black,fill=azure(colorwheel),line width=3.2mm]
		\draw (26.5mm,6mm)--(26.5mm,30mm);
		\draw (29.5mm,6mm)--(29.5mm,60mm);
		\draw (32.5mm,6mm)--(32.5mm,60mm);
		\draw (35.5mm,6mm)--(35.5mm,60mm);
		\draw (38.5mm,6mm)--(38.5mm,60mm);
		\draw (41.5mm,6mm)--(41.5mm,60mm);
		\draw (44.5mm,6mm)--(44.5mm,60mm);
		\draw (47.5mm,6mm)--(47.5mm,60mm);
		\draw (50.5mm,6mm)--(50.5mm,60mm);
		\draw (53.5mm,6mm)--(53.5mm,30mm);
				
		\draw (107.7mm,6mm)--(107.7mm,60mm);
		\draw (110.7mm,6mm)--(110.7mm,60mm);
		\draw (113.7mm,6mm)--(113.7mm,60mm);
		\draw (116.7mm,6mm)--(116.7mm,60mm);
		\draw (119.7mm,6mm)--(119.7mm,60mm);
		\draw (122.7mm,6mm)--(122.7mm,60mm);
		\draw (125.7mm,6mm)--(125.7mm,60mm);
		\draw (128.7mm,6mm)--(128.7mm,60mm);
	\end{scope}
	...
	\end{scope}
	\begin{scope}[azure(colorwheel)!90!white,fill=azure(colorwheel)!30!white,line width=2pt] 
		\draw (10mm,6mm)--(10mm,80mm);
		\draw (76mm,6mm)--(76mm,80mm);
		\draw (142mm,6mm)--(142mm,80mm);
	\end{scope}
